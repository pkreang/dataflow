...
use App\Models\DocumentFormDepartment;
...
class UatMultiApprovalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // HR submitter
        $hrStaff = $this->makeUser('hr.staff@abc.co.th',  'สมหมาย', 'ใจดี',   $hrDept->id, null,              $viewerRole,   $password);
        ...
        $acctStaff = $this->makeUser('acct.staff@abc.co.th', 'บัญชา', 'ตรงไป',  $acctDept->id, null,               $viewerRole,   $password);
