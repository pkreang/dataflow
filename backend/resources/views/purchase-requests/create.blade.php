...
@section('content')
    <div class="mb-6">
        ...
        <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100 mt-2">{{ __('common.create_purchase_request') }}</h2>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">{{ __('common.purchase_request_desc') }}</p>
    </div>
    ...
    <div x-data="prForm()" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card p-5">
            ...
            <div class="mt-4">
                <button type="submit" form="pr-form" class="btn-primary w-full py-2.5">
                    {{ __('common.submit') }}
                </button>
            </div>
        </div>
