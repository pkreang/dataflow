...
return [
    ...
    'encoding' => 'ข้อมูล :attribute ต้องเข้ารหัสด้วย :encoding',
    ...
    'password_reused' => 'กรุณาใช้รหัสผ่านที่ไม่เคยใช้ในช่วงล่าสุด (ตามนโยบายห้ามใช้รหัสซ้ำ)',
    'password_same_as_current' => 'รหัสผ่านใหม่ต้องไม่เหมือนรหัสผ่านปัจจุบัน',
    ...
    'document_form' => [
        ...
        'field_key_reserved' => 'คีย์ฟิลด์นี้สงวนไว้ใช้ภายในระบบ (id, status, user_id, ฯลฯ) — กรุณาตั้งชื่ออื่น',
        'table_name_conflicts_system' => 'ชื่อตารางนี้ซ้ำกับตารางในระบบ — กรุณาใช้ชื่ออื่น',
        ...
        'foreign_key_required' => 'กรอกคีย์เชื่อมโยงเมื่อฟิลด์ค้นหานี้อ้างอิงฟิลด์ค้นหาอื่น',
        'foreign_key_invalid' => 'คีย์เชื่อมโยงใช้ได้เฉพาะตัวพิมพ์เล็กและขีดล่าง',
        'options_required' => 'เพิ่มอย่างน้อยหนึ่งตัวเลือก (บรรทัดละหนึ่งรายการ)',
        'table_columns_required' => 'เพิ่มอย่างน้อยหนึ่งคอลัมน์ในตาราง',
        'table_columns_invalid_json' => 'ข้อมูลคอลัมน์ตารางต้องเป็น JSON ที่ถูกต้อง',
        'table_columns_too_many' => 'คอลัมน์ในตารางมากเกินไป',
        'table_column_invalid' => 'แต่ละคอลัมน์ต้องเป็นรูปแบบที่ถูกต้อง',
        'table_column_key_invalid' => 'แต่ละคอลัมน์ต้องมีคีย์ที่ไม่ว่าง และใช้ตัวอักษร ตัวเลข ขีด หรือขีดล่าง',
        'table_column_type_invalid' => 'ประเภทคอลัมน์ตารางไม่ถูกต้อง',
        'table_column_keys_duplicate' => 'คีย์คอลัมน์ในตารางต้องไม่ซ้ำกัน',
    ],
