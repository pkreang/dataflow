...
return [
    ...
    'line_channel_secret' => 'Channel Secret (สำหรับ webhook)',
    'line_channel_secret_placeholder' => 'Messaging API channel secret',
    'line_channel_secret_hint' => 'จำเป็นสำหรับ อนุมัติ/ไม่อนุมัติ ผ่านปุ่มใน LINE อยู่ที่แท็บ "Messaging API" (ต่างจาก LINE Login channel secret)',
