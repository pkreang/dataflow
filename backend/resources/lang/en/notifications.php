...
return [
    ...
    'line_channel_secret' => 'Channel Secret (for webhook)',
    'line_channel_secret_placeholder' => 'Messaging API channel secret',
    'line_channel_secret_hint' => 'Required for approve/reject via LINE buttons. Found under "Messaging API" tab — different from the LINE Login channel secret.',
